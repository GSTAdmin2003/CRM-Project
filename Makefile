...
help:
	...
	@echo "  make dev        - Start with DEBUG=True and auto-reload"
...
# Start Django development server with Docker
run:
...
# Development mode with explicit debug
dev:
	@echo "Starting Django in development mode with Docker..."
	docker compose up web
