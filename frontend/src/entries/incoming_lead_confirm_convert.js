...
function mount() {
    const el = document.getElementById('svelte-incoming_lead_confirm_convert-root');
    const dataEl = document.getElementById('incoming_lead_confirm_convert-init-data');
    if (!el || !dataEl) return;
