...
class ActivityTypeAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Activity Type Information", {"fields": ("name", "icon", "color", "is_active")}),
...
class ActivityAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Activity Information", {"fields": ("activity_type", "title", "description")}),
        ("Assignment", {"fields": ("lead", "assigned_to", "scheduled_date", "status")}),
        ("Outcome", {"fields": ("outcome", "completed_at"), "classes": ("collapse",)}),
        (
            "Tracking",
